 ...
 * @date: 2020/1/4 19:58
 * InitSequenceFileJob 的 InputFormat，将input的数据处理成bytes数组，作为InitSequenceFileJob中map的value
 */
...
class InitSequenceFileRecordReader extends RecordReader<NullWritable, BytesWritable> {
    ...
    public void initialize(InputSplit inputSplit, TaskAttemptContext taskAttemptContext) throws IOException, InterruptedException {
        ...
        // initialize fileSplit:hdfs://localhost:9000/input/ROM/483856newsML.txt
    }

    /**
     * nextKeyValue() 在Mapper中的map函数中赋值value的时候会调用
     */
    @Override
